	...
	<body data-spy="scroll" data-target="#nav-side">
		...
		<div class="wrapper clearfix" >
			...
			<div id="person-info-body">
				...
				<!-- <form action="<?php echo U('Person/submit');?>" name="form" method="post"> -->
				...
				<!-- </form> -->
				<form action="<?php echo U('Person/savePortrait');?>" name="form" method="post" id="form1" runat="server" enctype="multipart/form-data">
